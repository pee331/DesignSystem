...
#[derive(Debug)]
pub struct DesignSystemProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DesignSystemProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DesignSystem processing");
    
    let mut processor = DesignSystemProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DesignSystemProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DesignSystemProcessor::new(false);
